...
# ╔═╡ 6491b021-bbcd-4d0a-8d21-3700bd293811
iiifservice = IIIFservice(baseiiifurl, iiifroot)

# ╔═╡ 66348cac-5571-46ad-85ff-a01649aa9e00
 src = hmt_cex()

# ╔═╡ 09719dd0-7a87-4c73-a22a-43fbe43695a9
# ╠═╡ show_logs = false
imagecollections = filter(coll -> length(coll) > 1, hmt_images(src))
...
begin
	collmenu = Pair{String,String}[]
	 for coll in imagecollections
        push!(collmenu, Pair( string(urn(coll)),label(coll), ))
    end
	collmenu
end
...
git-tree-sha1 = "f6c03d5758c2df418271ac65f13ddac2603818dd"
...
git-tree-sha1 = "0b1ebd4d495d1a06e77013179048a1a5bad64b36"
...
git-tree-sha1 = "42edfc62bcf73a7402fa93ff55cea3ca3fea0e5e"
...
git-tree-sha1 = "49d3359a89768aaa2a9673909fc584ac1c2d2fc9"
...
git-tree-sha1 = "0052f104ceb6f058f7d29e81c82794a6c95b6860"
...
git-tree-sha1 = "c62da6337825ee6e47369314ea8aab460be735d8"
...
git-tree-sha1 = "47185ddd3df2ddef2384235215fc57988d6d94ab"
...
git-tree-sha1 = "1f0608df6d0a1a0a0204eb11d4cf3a96120bce42"
...
git-tree-sha1 = "624706a9259b3f584c4a6b081970bbe4e0778175"
...
git-tree-sha1 = "6e4cf6377a87e9d5c23a0a00e5a54d9de84fbda1"
